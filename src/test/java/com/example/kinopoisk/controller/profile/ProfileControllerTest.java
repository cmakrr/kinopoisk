...
import com.example.kinopoisk.service.review.implementations.CustomReviewService;
...
class ProfileControllerTest {
    ...
    @MockBean
    private CustomReviewService customReviewService;
    ...
    void deleteById() throws Exception{
        User user = new User();
        user.setId(1L);
        String url = String.format("/profile/delete/%d",user.getId());
